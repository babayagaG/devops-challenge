...
- Serve webpages from `/home/nginx/` directory when users visit https://www.example4.com
- Redirect non-http request from http://www.example4.com to https://www.example4.com
- Rewrite URL from directory `images` to directory `assets`. Example: https://www.example7.com/images/a.jpg to https://www.example7.com/assets/a.jpg
